package com.example.myapplication4234;
...
public class NewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsRecordBtn = findViewById(R.id.newsRecordBtn);
        ...
        else
        {
            new Thread() {
                ...
                public void run() {
                    ...
                    String clientId = "ry3cAv_hfV_ksbpk3OXH";//애플리케이션 클라이언트 아이디값";
                    String clientSecret = "CuVMx62ZZK";//애플리케이션 클라이언트 시크릿값";
                    try {
